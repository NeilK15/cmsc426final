...
model = YOLO("yolo11n-handpose.onnx", task="pose")
...
try:
    ...
    while True:
            ...
            if sock is None:
                ...
                for result in results:
                    ...
                    if keypts.shape[0] > 0 and keypts.shape[1] > 0:
                        ...
                        rightwrist = norm_keypts[0][9].tolist()

                        # Get visibility of the keypoints
                        leftwrist_visibility = float(keypts[0][9][2])
                        rightwrist_visibility = float(keypts[0][9][2])
        ...
        except (ConnectionRefusedError, BrokenPipeError) as msg:
            print(msg)
            connected = False
            time.sleep(2)
